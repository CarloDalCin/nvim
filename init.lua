...
Plug('https://github.com/nat-418/boole.nvim') -- invert true with false
Plug('tpope/vim-surround')
Plug( 'iamcco/markdown-preview.nvim')
Plug('nvim-treesitter/nvim-treesitter', { ['do'] = function() fn[':TSUpdate']() end })
--Plug('nvim-treesitter/playground') -- useful for a custom theme
